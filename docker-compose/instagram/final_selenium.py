...
#Set this line to false if headless option is commented
headless = True
...
print( photo_links[19].get_attribute("href") )
os.system("/opt/sansa-bot/python_instagram/script.sh " + photo_links[19].get_attribute("href"))
